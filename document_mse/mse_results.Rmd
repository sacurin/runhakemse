...
```{r ssb-biasadjust087-table}
yr_start <- 2019
table_timeseries(ps_b,
                 type = "ssb",
                 yr_lim = c(yr_start, NA),
                 scen = 1,
                 caption = "Table of mid-year Spawning Biomass values for the bias adjust = 0.87 scenario.")
```
...
table_timeseries(ps_c,
                 ...
                 scen = 1,
                 decimals = 3,
                 caption = "Catch / quota for the base climate scenario.")
```
