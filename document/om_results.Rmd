...
```{r age-in-catch-by-country, fig.cap = "Average age in catch by country for the new OM. This is calculated as the fishing mortality * numbers-at-age * weight-at-age"}
